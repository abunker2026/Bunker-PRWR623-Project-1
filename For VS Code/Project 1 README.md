# Verifying and Recording Research Outputs
...
Although not the focus of the documentation, other funding organization personnel may find this guide useful:

* Program Evaluators - Personnel who are not responsible for recording publications in the repository and do not have detailed knowledge about the specific grants, but may use the data to conduct downstream impact analyses. Program Evaluators should be familiar with the criteria that determines which publications are recorded.
* Program Analysts - Support personnel who may be tasked with performing quality control checks on the data captured in the publication repository. Analysts need to know what standards are set for a "complete record" to ensure that the data is captured uniformly for all publications.

## Purpose

After using this documentation research administrators will be able to:

1. Uniformly apply criteria to determine the relatedness of published research to grants in their portfolio.
2. Follow a standard operating procedure to enter publication data in a centralized repository.
3. Trust that captured publication data is accurate and complete.
